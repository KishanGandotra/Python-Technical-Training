class Suspect:
    ...
    def __str__(self):
        return f"Suspect ID: {self.__suspect_id}, Name: {self.__first_name} {self.__last_name}, Date of Birth: {self.__date_of_birth}, Gender: {self.__gender}, Contact Information: {self.__contact_information}"
